 ...
 */
//**zodiac class for taurus**//
public class Taurus extends Activity {
    //** declare variables**//
    TextView tv,tv1,tv2,tv3;
    ImageView iv;
    Boolean connected;
    private String finalUrl="http://feeds.feedburner.com/AstroSageTaurus?format=xml";
